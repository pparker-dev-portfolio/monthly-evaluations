<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty-Master.Master" AutoEventWireup="true" CodeBehind="FacultyEvalReadOnly.aspx.cs" Inherits="Capstone_1_Monthly_Evaluation.FacultyEvalReadOnly" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <div class="schedulesJumbo p-3">
            ...
            <p>
                Student:
            <asp:Label ID="lblStudentName" runat="server" Text="Johanna Obrien" Style="font-weight: bold;"></asp:Label>
            </p>
            <p>
                Evaluator:
            <asp:Label ID="lblEvaluatorName" runat="server" Text="Ida Holt" Style="font-weight: bold;"></asp:Label>
            </p>
            ...
            <asp:RadioButtonList ID="RBLPassFail" runat="server" Enabled="False">
                <asp:ListItem Selected="True">Pass**</asp:ListItem>
                <asp:ListItem>Fail</asp:ListItem>
            </asp:RadioButtonList>

            <div class="d-flex justify-content-center">
                <asp:Button ID="btnReturn" runat="server" Text="Return" OnClick="btnSubmitFacultyEval_Click" CssClass="falTableButton"/>
            </div>
        </div>
    </div>
</asp:Content>
