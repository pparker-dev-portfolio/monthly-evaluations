<%@ Page Title="" Language="C#" MasterPageFile="~/Student-Master.Master" AutoEventWireup="true" CodeBehind="StudentEvalPage.aspx.cs" Inherits="Capstone_1_Monthly_Evaluation.StudentEvalPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div class="container">
        ...
        <div class="schedulesJumbo p-3">
            ...
            <br />
            <div class="d-flex justify-content-center">
                <asp:Button runat="server" ID="btnStudentEvalSubmit" Text="Submit Evaluation" OnClick="btnStudentEvalSubmit_Click" CssClass="falApplyFilters"/>
            </div>
            <br />
        </div>
    </div>
